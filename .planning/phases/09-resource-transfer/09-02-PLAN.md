...
must_haves:
  ...
  artifacts:
    - path: "lxmf-core/src/test/kotlin/network/reticulum/lxmf/interop/ResourceCompressionTest.kt"
      provides: "BZ2 compression interop tests"
      exports: ["ResourceCompressionTest"]
    - path: "lxmf-core/src/test/kotlin/network/reticulum/lxmf/interop/ResourceProgressTest.kt"
      provides: "Progress callback verification test"
      exports: ["ResourceProgressTest"]
  key_links:
    - from: "ResourceCompressionTest"
      to: "InteropTestBase"
      via: "inheritance for Python bridge"
      pattern: "extends InteropTestBase"
    - from: "ResourceProgressTest"
      to: "DirectDeliveryTestBase"
      via: "inheritance for LXMF delivery testing"
...
Output: ResourceCompressionTest with 4 passing tests covering BZ2 interop, and ResourceProgressTest verifying progress callbacks.
</objective>
...
- python-bridge/bridge_server.py (has existing bz2_compress/bz2_decompress commands at lines 2602, 2621)
</context>

<tasks>

<task type="auto">
  <name>Task 1: Create ResourceCompressionTest with BZ2 interop tests</name>
...
NOTE: The Python bridge already has bz2_compress and bz2_decompress commands (bridge_server.py lines 2602, 2621).
...
<task type="auto">
  <name>Task 2: Add progress callback verification test</name>
  <files>lxmf-core/src/test/kotlin/network/reticulum/lxmf/interop/ResourceProgressTest.kt</files>
  <action>
Create a separate test class that extends DirectDeliveryTestBase for progress callback testing:
