...
<task type="auto">
  ...
  <action>
First, create the interop directory if it doesn't exist:
```bash
mkdir -p lxmf-core/src/test/kotlin/network/reticulum/lxmf/interop
```

Then create LXMFInteropTestBase.kt that extends InteropTestBase and provides:
